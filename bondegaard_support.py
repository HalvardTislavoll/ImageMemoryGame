...
def velcome_msg():
    ...
    _show(title='Velkomst melding', 
          message='''
    V E L K O M M E N
    
Bondegårdslotto er eit 
bildelotto, det blir òg
kalla memory.
...
def test_fill_game_board():
    _w1.Frame2.configure(background="green")
    set_fremside()
    set_background()
...
def on_slide(*args):
    ...
    break_length=5000   # milli second
    a_break(break_length)
