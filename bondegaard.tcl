...
#  Dec 06, 2023 12:28:58 PM CET  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 1456x738+1976+199
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
set site_3_0 $top.m49
    ...
    place $site_3_0.scr51 \
        -in $site_3_0 -x 21 -y 75 -width 639 -relwidth 0 -height 601 \
        -relheight 0 -anchor nw -bordermode ignore 
    frame "$top.fra50" \
        -borderwidth 2 -background #919191 -height 680 -width 678 
    ...
    frame "$site_3_0.fra53" \
        -borderwidth 2 -background #919191 -height 225 \
        -highlightbackground #919191 -highlightcolor black -width 425 
    vTcl:DefineAlias "$site_3_0.fra53" "Frame5" vTcl:WidgetProc "Toplevel1" 1
    set site_4_0 $site_3_0.fra53
    ttk::label "$site_4_0.tLa52" \
        -font "-family {DejaVu Sans} -size 10" -relief flat -anchor e \
        -justify left -text "Spiller 3:" -compound left 
    vTcl:DefineAlias "$site_4_0.tLa52" "TLabel2_2" vTcl:WidgetProc "Toplevel1" 1
    ttk::label "$site_4_0.tLa53" \
        -font "-family {DejaVu Sans} -size 10" -relief flat -anchor e \
        -justify left -text "Spiller 4:" -compound left 
    vTcl:DefineAlias "$site_4_0.tLa53" "TLabel2_3" vTcl:WidgetProc "Toplevel1" 1
    ttk::label "$site_4_0.tLa55" \
        -font "-family {DejaVu Sans} -size 10" -relief flat -anchor e \
        -justify left -text "Spiller 1:" -compound left 
    vTcl:DefineAlias "$site_4_0.tLa55" "TLabel2" vTcl:WidgetProc "Toplevel1" 1
    ttk::label "$site_4_0.tLa51" \
        -font "-family {DejaVu Sans} -size 10" -relief flat -anchor e \
        -justify left -text "Spiller 2:" -compound left 
    vTcl:DefineAlias "$site_4_0.tLa51" "TLabel2_1" vTcl:WidgetProc "Toplevel1" 1
    ttk::entry "$site_4_0.tEn54" \
        -font "-family {DejaVu Sans} -size 10" -justify center \
        -textvariable "user" -cursor fleur 
    vTcl:DefineAlias "$site_4_0.tEn54" "TEntry1" vTcl:WidgetProc "Toplevel1" 1
    ttk::entry "$site_4_0.tEn47" \
        -font "-family {DejaVu Sans} -size 10" -justify center \
        -textvariable "user" -cursor fleur 
    vTcl:DefineAlias "$site_4_0.tEn47" "TEntry2" vTcl:WidgetProc "Toplevel1" 1
    ttk::entry "$site_4_0.tEn48" \
        -font "-family {DejaVu Sans} -size 10" -justify center \
        -textvariable "user" -cursor fleur 
    vTcl:DefineAlias "$site_4_0.tEn48" "TEntry3" vTcl:WidgetProc "Toplevel1" 1
    ttk::entry "$site_4_0.tEn49" \
        -font "-family {DejaVu Sans} -size 10" -justify center \
        -textvariable "user" -cursor fleur 
    vTcl:DefineAlias "$site_4_0.tEn49" "TEntry4" vTcl:WidgetProc "Toplevel1" 1
    place $site_4_0.tLa52 \
        -in $site_4_0 -x 46 -y 119 -width 154 -height 31 -anchor nw \
        -bordermode ignore 
    place $site_4_0.tLa53 \
        -in $site_4_0 -x 46 -y 169 -width 154 -height 31 -anchor nw \
        -bordermode ignore 
    place $site_4_0.tLa55 \
        -in $site_4_0 -x 46 -y 19 -width 154 -height 31 -anchor nw \
        -bordermode ignore 
    place $site_4_0.tLa51 \
        -in $site_4_0 -x 46 -y 69 -width 154 -height 31 -anchor nw \
        -bordermode ignore 
    place $site_4_0.tEn54 \
        -in $site_4_0 -x 216 -y 19 -width 206 -relwidth 0 -height 33 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.tEn47 \
        -in $site_4_0 -x 216 -y 69 -width 206 -height 33 -anchor nw \
        -bordermode ignore 
    place $site_4_0.tEn48 \
        -in $site_4_0 -x 216 -y 119 -width 206 -height 33 -anchor nw \
        -bordermode ignore 
    place $site_4_0.tEn49 \
        -in $site_4_0 -x 216 -y 169 -width 206 -height 33 -anchor nw \
        -bordermode ignore 
    ttk::label "$site_3_0.tLa54" \
        -font "-family {DejaVu Sans} -size 18 -weight bold" -relief flat \
        -anchor center -justify left -text "Spillere:" -compound left 
    vTcl:DefineAlias "$site_3_0.tLa54" "TLabel1" vTcl:WidgetProc "Toplevel1" 1
    ttk::button "$site_3_0.tBu55" \
        -command "on_TBtnPlay" -text "Spill" -compound left 
    vTcl:DefineAlias "$site_3_0.tBu55" "TBtnPlay" vTcl:WidgetProc "Toplevel1" 1
    place $site_3_0.fra53 \
        -in $site_3_0 -x 77 -y 144 -width 425 -relwidth 0 -height 225 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.tLa54 \
        -in $site_3_0 -x 176 -y 62 -width 344 -relwidth 0 -height 51 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.tBu55 \
        -in $site_3_0 -x 294 -y 470 -width 98 -relwidth 0 -height 33 \
        -relheight 0 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    ...
    place $top.fra50 \
        ...
        -anchor nw -bordermode ignore 
    place $top.fra51 \
        -in $top -x 9 -y 10 -width 686 -relwidth 0 -height 665 -relheight 0 \
        -anchor nw -bordermode ignore 
