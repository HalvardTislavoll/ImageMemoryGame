#############################################################################
# Generated by PAGE version 8.0D
#  in conjunction with Tcl version 8.6
#  Nov 29, 2023 12:42:33 AM CET  platform: Linux
set vTcl(timestamp) ""
...
if {!$vTcl(borrow) && \
        $vTcl(current_theme) ne "page-wheat" } {
    set vTcl(current_theme) page-wheat
    ttk::style theme use page-wheat
    vTcl:change_theme
...
if {$vTcl(current_theme) eq "page-default"} {
...
proc vTclWindow.top1 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        -menu $top.m49 -background wheat -highlightbackground wheat -highlightcolor black 
    ...
    frame "$top.fra48" \
        -borderwidth 2 -background wheat -height 680 \
        -highlightbackground wheat -highlightcolor black -width 678 
    vTcl:DefineAlias "$top.fra48" "Frame1" vTcl:WidgetProc "Toplevel1" 1
    set site_3_0 $top.fra48
    canvas "$site_3_0.can48" \
        -background wheat -borderwidth 4 -closeenough 1.0 -height 75 \
        -highlightbackground wheat -highlightcolor black \
        -insertbackground black -selectbackground #d9d9d9 \
    ...
    place $site_3_0.can48 \
        ...
        -relheight 0 -anchor nw -bordermode ignore 
    menu "$top.m49" \
        -activebackground #d9d9d9 -activeforeground black -background wheat \
...
set site_3_0 $top.m49
    ...
    spinbox "$top.spi47" \
        ...
        -insertbackground black -readonlybackground #f5deb3 \
    ...
    canvas "$site_3_0.can48" \
        -background wheat -borderwidth 4 -closeenough 1.0 -height 180 \
        -highlightbackground wheat -highlightcolor black \
        -insertbackground black -relief solid -selectbackground #d9d9d9 \
        -selectforeground black -width 170 
    ...
    place $top.tLa48 \
        ...
        -anchor nw -bordermode ignore 
    place $top.tLa49 \
        -in $top -x 202 -y 687 -width 955 -relwidth 0 -height 40 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.tBu50 \
